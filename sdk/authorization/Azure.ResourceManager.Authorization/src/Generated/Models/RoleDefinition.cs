...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class RoleDefinition
    {
        ...
        internal RoleDefinition(string id, string name, string type, string roleName, string description, string roleType, IList<Permission> permissions, IList<string> assignableScopes)
        {
            Id = id;
            Name = name;
            Type = type;
