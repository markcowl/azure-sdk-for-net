...
namespace Azure.ResourceManager.Authorization
{
    ...
    public partial class RoleAssignmentsOperations
    {
        ...
        internal RoleAssignmentsOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new RoleAssignmentsRestOperations(clientDiagnostics, pipeline, subscriptionId, endpoint);
